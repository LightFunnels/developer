...
<Row>
  <Col>
		### Fields
		<Properties> 
			<Property name="list" label="[AppCharge!]!" route='/apps/types#app-charge'>
...
<Row>
  <Col>
		...
		<Properties> 
			...
			<Property name="recurring" label="AppChargeInterval" route="/apps#app-charge-interval">
...
<Row>
  <Col>
		### Fields
		<Properties> 
			<Property name="node" label="AppChargeInput!" route="/apps#types#app-charge-input">
...
<Row>
  <Col>
		### Fields
		<Properties> 
			<Property name="appCharge" label="AppCharge" route="/apps#app-charge">
				The app charge type.
			</Property>
			<Property name="clientMutationId" type="String">
