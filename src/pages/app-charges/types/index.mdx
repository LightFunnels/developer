...
<Row>
  <Col>
		...
		<Properties> 
			...
			<Property name="recurring" label="AppChargeInterval" route="/app-charges#app-charge-interval">
...
<Row>
  <Col>
		### Fields
		<Properties> 
			<Property name="appCharge" label="AppCharge" route="/app-charges#app-charge">
				The app charge type.
			</Property>
			<Property name="clientMutationId" type="String">
