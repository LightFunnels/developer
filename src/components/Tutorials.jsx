      ...
      <div className="not-prose mt-4 border-t border-zinc-900/5 pt-10 dark:border-white/5">
        <div className="mb-5">
          ...
          <a className="relative w-max block" href="https://www.lightfunnels.co/academy/apps-development" target="_blank" rel="noreferrer">
            <img className="absolute top-1/2 right-1/2 [transform:translate(50%,-50%)] max-w-[50px]" src="/images/yutab.webp" alt=""/>
            <img className="max-w-[500px]" src="/images/thumbnail.jpg" alt="" />
          </a>
      </div>
    </div>
  )
