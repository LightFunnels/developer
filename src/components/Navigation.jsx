...
export const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'Discounts', href: '/discounts/types' },
      { title: 'Funnels', href: '/funnels/types' },
      { title: 'Orders', href: '/orders/types' },
      { title: 'Products', href: '/products/types' },
      { title: 'Reviews', href: '/reviews/types' },
